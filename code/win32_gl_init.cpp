...
internal void Win32LoadWGLFunctions()
{
    ...
    wglMakeContextCurrentARB = (PFNWGLMAKECONTEXTCURRENTARBPROC)Win32LoadOpenGLProc("wglMakeContextCurrentARB");
...
void deleteGLContext(HGLRC glContext, HDC deviceContext)
{
